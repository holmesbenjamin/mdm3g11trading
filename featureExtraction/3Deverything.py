...
ani = FuncAnimation(fig_embed, update, frames=np.arange(1, 21, 0.5), repeat=False, interval=50)  

# Save the animation
animation_filename = f"commodity_{commodity}_delay_embedding_animation.mp4"
